...
#ifndef GMATELASTOPLASTICFINITESTRAINSIMO_VERSION_HPP
#define GMATELASTOPLASTICFINITESTRAINSIMO_VERSION_HPP
...
{
    return detail::unquote(std::string(QUOTE(GMATELASTOPLASTICFINITESTRAINSIMO_VERSION)));
}
...
inline std::vector<std::string> version_dependencies()
{
    ...
    ret.push_back("gmatelastoplasticfinitestrainsimo=" + version());
